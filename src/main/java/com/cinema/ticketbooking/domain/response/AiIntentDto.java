...
public record AiIntentDto(@NotNull Intent intent, @Size(max=100) String genre,
 ...
 public AiIntentDto(Intent intent,String genre,Integer maxDuration,LocalDate date,Integer people,BigDecimal budget){this(intent,genre,maxDuration,date,people,budget,null);}
 public enum Intent { MOVIES, MORE_MOVIES, MOVIE_DETAILS, SEATS, DISCOUNTS, GREETING, CLARIFY }
}
