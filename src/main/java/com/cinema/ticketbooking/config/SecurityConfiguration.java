    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(
                        authz -> authz
                                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/v1/assistant/recommendations", "/api/v1/assistant/seat-recommendations", "/api/v1/assistant/chat").permitAll()
